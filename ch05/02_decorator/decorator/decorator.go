...
// The ClientFunc function is a function type that implements
...
func (ClientFunc) SetRatelimit(duration time.Duration) error {
	ratelimitDuration = duration
	return nil
}

func (ClientFunc) GetRatelimit() (time.Duration, error) {
...
func FaultTolerance(attempt int, backoff time.Duration) Decorator {
	return func(c Client) Client {
		return ClientFunc(func(r *http.Request) (*http.Response, error) {
